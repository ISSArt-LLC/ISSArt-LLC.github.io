---
id: 808
title: 'What you should know about software development process'
date: '2015-02-26T11:14:01+08:00'
author: 'Olga Rekovskaya'
layout: post
image: /static/img/2015/02/clock-102060.jpg
categories:
    - General
---
...
Software development method means a framework that is used to structure, plan, and control the process of developing an information system.\[1\] There are various software development methods – Agile, Scrum, Extreme Programming, Test Driven Development, Waterfall, and more. The full list can be found [here](https://en.wikipedia.org/wiki/List_of_software_development_philosophies).
...
| Personal Software Process (PSP) | A prescriptive software process for individual developers. | 1 | TBD |
