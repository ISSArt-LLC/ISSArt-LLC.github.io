...
| id | creation_time | collection_id | … |
|---|---|---|---|
...
| id | creation_time | collection_id | catalogue_names | … |
|---|---|---|---|---|
| primary key |  |  | set | … |
...
| id | catalogue_name | creation_time | collection_id | … |
|---|---|---|---|---|
| primary key(id | , catalogue_name) |  |  | … |
